  ...
  var secondsLeft = 15; // 30 in seconds
  var timerInterval;
...
let audio = new Audio('../sound/NewTimer15-Sec.mp3'); // Change the path to your audio file
...
function resetTimer() {
    ...
    secondsLeft = 15; // Reset the timer to 9 seconds (or 2 minutes, as intended)
